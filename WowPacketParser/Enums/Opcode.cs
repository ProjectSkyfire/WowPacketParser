namespace WowPacketParser.Enums
{
    public enum Opcode
    {
        ...
        */
        ...
        // BATTLEPET
        SMSG_BATTLEPET_ERROR,
        SMSG_BATTLEPET_JOURNAL_LOCK,
        SMSG_BATTLEPET_UPDATES,
        SMSG_BATTLEPET_CAGE_DATE_ERROR,
        SMSG_BATTLEPET_RESTORED,
        SMSG_BATTLEPET_HEALED,
        SMSG_BATTLEPET_REVOKED,
        SMSG_BATTLEPET_NAME_QUERY,
        SMSG_BATTLEPET_JOURNAL,
        SMSG_BATTLEPET_TRAP_LEVEL, 
        SMSG_BATTLEPET_LICENSE_UPDATE,
        SMSG_BATTLEPET_DELETED, 
        SMSG_BATTLEPET_JOURNAL_LOCK_ACQUIRED,

        SMSG_PETBATTLE_INITIAL_UPDATE,
        SMSG_PETBATTLE_ROUND_RESULT,
        SMSG_PETBATTLE_QUEUE_PROPOSE_MATCH,
        SMSG_PETBATTLE_SLOT_UPDATE,
        SMSG_PETBATTLE_REPLACEMENT_MADE,
        SMSG_PETBATTLE_FINAL_ROUND, 
        SMSG_PETBATTLE_PVP_CHALLENGE,
        SMSG_PETBATTLE_DEBUG_QUEUE_DUMP_RESPONSE,
        SMSG_PETBATTLE_QUEUE_STATUS,
        SMSG_PETBATTLE_GAME_LENGTH_WARNING,
        SMSG_PETBATTLE_REQUEST_FAILED,
        SMSG_PETBATTLE_FINISHED,
        SMSG_PETBATTLE_FIRST_ROUND,
        SMSG_PETBATTLE_CHAT_RESTRICTED,
        SMSG_PETBATTLE_FINANLIZE_LOCATION,
